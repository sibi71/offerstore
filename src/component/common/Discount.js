    ...
    <>
      {discount > 1 && (
        <span
          className={
            modal
              ? "absolute text-dark text-sm bg-blue-600 text-white py-1 px-2 rounded font-medium z-10 left-4 top-4"
              : slug
              ? "text-dark text-sm bg-blue-600 text-white py-1 px-2 rounded font-medium z-10 right-4 top-4"
              : " absolute text-dark text-xs bg-blue-600 text-white py-1 px-2 rounded font-medium z-10 right-4 top-4"
          }
        >
          {discount}% Off
        </span>
