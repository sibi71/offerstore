...
console.log(product);
  ...
  return (
    <>
      ...
      <div className="group box-border overflow-hidden flex rounded-md shadow-sm pe-0 flex-col items-center bg-white relative border-solid border-2 border-black-500">
        <div
